...
![Overall_Cancellation_Status](https://github.com/MudavadiF80/Hotel-Booking-Cancellation-Analysis/blob/main/Images/cancellation.png)
### 2. Cancellation by Hotel Type
![Cancellation_by_Hotel_Type](https://github.com/MudavadiF80/Hotel-Booking-Cancellation-Analysis/blob/main/Images/hoteltype.png)
### 3. Top 10 Countries
![Top_10_Countries](https://github.com/MudavadiF80/Hotel-Booking-Cancellation-Analysis/blob/main/Images/countries.png)

🚀 How to Run the Project
Clone the repository:

Bash
git clone [https://github.com/MudavadiF80/hotel-booking-cancellation-analysis.git](https://github.com/MudavadiF80/hotel-booking-cancellation-analysis.git)
